...
━━━━━━━━━━━━━━━━`
        ...
        if (subCommand === "balance" || subCommand === "solde") {
            return message.reply(`📋 𝐂𝐚𝐩𝐢𝐭𝐚𝐥 𝐚𝐜𝐭𝐮𝐞𝐥: ${formatNumber(userData.money)}$`);
        }
        ...
        if (subCommand === "bonus") {
            ...
            return message.reply(`🎁 𝐁𝐨𝐧𝐮𝐬 𝐪𝐮𝐨𝐭𝐢𝐝𝐢𝐞𝐧 !\n━━━━━━━━━━━━━━━━\n✨ +𝟐𝟎𝟎$\n💰 𝐍𝐨𝐮𝐯𝐞𝐚𝐮 𝐬𝐨𝐥𝐝𝐞 : ${formatNumber(newUserData.money)}$`);
        }
...
🎲 𝐌𝐨𝐧𝐭𝐚𝐧𝐭 : ${formatNumber(amount)}$`
        ...
        if (randomWin) {
            ...
            if (baseWin) {
                ...
                if (betType === "petit" || betType === "grand" || betType === "simple") {
                    payout = 3;
                }
            } else {
                payout = 1;
